                        ...
                        <Box mx="10px" my="10px" mb="30px" display={"flex"} justifyContent={"space-between"} w={"1450px"}>
                          ...
                          <Box>
                            <Select w={"200px"} onChange={(event) => handleChangeOrderStatus({ orderId: order.orderId, statusName: event.target.value })}>
                              ...
                              <option disabled={order.orderStatus === "Đã Thanh Toán" || order.orderStatus === "Chờ Xác Nhận" || order.orderStatus === "Đã Xác Nhận" || order.orderStatus === "Đang Vận Chuyển" || order.orderStatus === "Đã Giao" || order.orderStatus === "Đã Hủy"} value="Chờ Xác Nhận">Chờ Xác Nhận</option>
                              <option disabled={order.orderStatus === "Đã Thanh Toán" || order.orderStatus === "Đã Xác Nhận" || order.orderStatus === "Đang Vận Chuyển" || order.orderStatus === "Đã Giao" || order.orderStatus === "Đã Hủy"} value="Đã Xác Nhận">Đã Xác Nhận</option>
